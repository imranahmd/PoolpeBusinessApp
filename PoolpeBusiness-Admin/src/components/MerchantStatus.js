                          ...
                          {creationError400[user.id] && (
                            <div className="border border-red-500 bg-red-50 p-4 rounded-md mt-2 shadow-md">
                              <p className="text-red-700 font-semibold">
                                <strong>Response Code:</strong> {creationError400[user.id].responseCode}
                              </p>
                              <p className="text-red-700 mt-2">
                                <strong>Message:</strong> {creationError400[user.id].responseMessage}
                              </p>
                              {creationError400[user.id].responseError && (
                                <p className="text-red-700 mt-2">
                                  <strong>Additional Info:</strong> {creationError400[user.id].responseError}
                                </p>
                              )}
                            </div>
                          )}
